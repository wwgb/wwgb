  ...
  <foreignObject x="20" y="20" width="560" height="140">
    <div xmlns="http://www.w3.org/1999/xhtml" style="color: #c9d1d9; font-family: -apple-system, 'Segoe UI', Roboto, sans-serif;">
      ...
      <div style="margin-top: 15px;">
        ...
        <span style="background:#8957e5; padding:4px 12px; border-radius:20px; font-size:0.8em; margin-right:6px;">Python</span>
        <span style="background:#d29922; padding:4px 12px; border-radius:20px; font-size:0.8em;">React</span>
      </div>
    </div>
  </foreignObject>
</svg>
...
<picture>
  ...
  <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/wwgb/wwgb/output/github-contribution-grid-snake.svg">
</picture>
