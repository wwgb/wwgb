  ...
  <tr>
    ...
    <td align="center" valign="top" style="padding: 6px;">
      <svg width="100%" viewBox="0 0 240 180" xmlns="http://www.w3.org/2000/svg">
        ...
        <foreignObject x="10" y="10" width="220" height="160">
          <div xmlns="http://www.w3.org/1999/xhtml" style="color:#c9d1d9; font-family:sans-serif; text-align:center;">
            <div style="font-size:1.5em; margin:5px 0;">🧻 vs 🥕</div>
            <img src="cat.png" width="100" alt="小猫" style="display:block; margin:0 auto;" />
    ...
    <td align="center" valign="top" style="padding: 6px;">
      <a href="https://github.com/wwgb/my-blog">
        <svg width="100%" viewBox="0 0 240 180" xmlns="http://www.w3.org/2000/svg">
          <rect width="240" height="180" rx="10" fill="#0d1117" stroke="#30363d" stroke-width="1.5"/>
          <foreignObject x="15" y="15" width="210" height="150">
